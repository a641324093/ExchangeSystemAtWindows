...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/title_看图王.jpg"))); // NOI18N
    ...
    private void but_logActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_but_logActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,"服务器连接加载失败！");
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this,"服务器连接出错！");
            Logger.getLogger(LoginFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
